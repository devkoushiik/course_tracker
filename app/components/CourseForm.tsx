        ...
        <div className="relative p-[2px] rounded-lg bg-gradient-to-r from-purple-600 via-yellow-400 to-black">
          <div className="bg-white rounded-lg p-12">
            <div className="flex flex-col items-center justify-center text-gray-500">
              <svg className="w-24 h-24 mb-6 text-purple-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <p className="text-2xl font-medium text-purple-600">Please Insert Data Sir</p>
              <p className="mt-3 text-base">Start by adding your first course using the form above</p>
            </div>
          </div>
        </div>
      ) : (
